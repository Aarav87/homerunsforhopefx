    ...
    return (
        <div className="font-raleway">
            ...
            <header className="flex relative">
                <img alt="Banner" src="/banner.png" className="duration-300 transition-filter w-full h-[100vh] object-cover" />
                <div className="absolute h-screen w-full p-4 xs:p-8 sm:p-16 flex flex-col justify-center items-center bg-black/60">
                    <div className="text-center">
                        <div className="mb-4">
                            <div className="flex flex-col flex-wrap gap-1 text-6xl sm:text-7xl lg:text-9xl font-extrabold">
                    ...
                    <div className="md:w-3/4 lg:w-1/2 mb-6 flex flex-col gap-2 text-white">
